...
public class Solution {
    ...
    private static String numbers[] = { "zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve", "thirteen", "fourteen", "quarter", "sixteen", "seventeen", "eighteen", "nineteen", "twenty", "twenty one", "twenty two", "twenty three", "twenty four", "twenty five","twenty six", "twenty seven", "twenty eight", "twenty nine", "half" };
    ...
    private static String getMinutsRules(Integer num) {
        ...
        if (num == 0) {
            ...
            int val = 60 - num;
            if (val == 1) {
                return (str.append(getStringNumber(num)).append(" minute to ")).toString();
